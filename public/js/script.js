...
// email: sindriber@gmail.is
// Original authoer: Snær Seljan Þóroddsson
//------------------------------------------------
var movieapp = {
  init: function() {
    this.menu();
          ...
          if (isOpen) {
            ...
            for (
              ...
              if (
                ...
                element.className.indexOf('filter_container') > -1
              ) {
                return;
              }
              level++;
  ...
  destroyLoader: function() {
    ...
    if (window.location.pathname == '/') {
      classie.add(
        document.querySelector('.loading_container.frontpage'),
        'hidden'
      );
    }
  }
